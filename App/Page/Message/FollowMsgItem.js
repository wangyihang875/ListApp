...
export default class FollowMsgItem extends Component {
    render(){
        return(
                ...
                <View style = {styles.Item}>
                    <View>
                        ...
                        <View style={styles.itemImage}>
                            <Icon name="ios-heart-outline" size={25} color='#FFF' />
                        </View>
                    </View>
                    <View style={styles.ItemContent}>
                        ...
                        <View style={styles.ItemContentLeft}>
                            ...
                            <View style={styles.ItemContentTitle}>
                                <Text style={styles.messageTitleText}>{this.props.Message.msg_content ? this.props.Message.msg_content : '暂无关注任务提醒'}</Text>
                            </View>
                        </View>
                    </View>
                </View>
